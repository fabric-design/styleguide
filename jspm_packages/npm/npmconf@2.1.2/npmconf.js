...
(function(process) {
  ...
  Conf.prototype.loadPrefix = require('./lib/load-prefix');
  Conf.prototype.loadCAFile = require('./lib/load-cafile');
  Conf.prototype.loadUid = require('./lib/load-uid');
  Conf.prototype.setUser = require('./lib/set-user');
  Conf.prototype.findPrefix = require('./lib/find-prefix');
  Conf.prototype.getCredentialsByURI = require('./lib/get-credentials-by-uri');
  Conf.prototype.setCredentialsByURI = require('./lib/set-credentials-by-uri');
