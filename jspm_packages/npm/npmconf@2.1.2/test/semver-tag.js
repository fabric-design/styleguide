...
var cli = {tag: 'v2.x'};
var projectData = {};
var expectList = [cli, envDataFix, projectData, ucData, gcData, biData];
var expectSources = {
  cli: {data: cli},
  env: {
    data: envDataFix,
...
test('tag cannot be a SemVer', function(t) {
  ...
  var expect = ['invalid config tag="v2.x"', 'invalid config Tag must not be a SemVer range'];
