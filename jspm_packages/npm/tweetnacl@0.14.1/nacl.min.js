...
!function(r) {
  ...
  function b(r, n, e, t, o, i) {
    ...
    for (y[3] &= 15, y[4] &= 252, y[7] &= 15, y[8] &= 252, y[11] &= 15, y[12] &= 252, y[15] &= 15; o > 0; ) {
      ...
      for (u = 0; 16 > u && o > u; ++u)
        l[u] = e[t + u];
      for (l[u] = 1, t += u, o -= u, v(s, l), f = 0; 17 > f; f++)
    ...
    for (u = 0; 17 > u; u++)
      h[u] = s[u];
    for (v(s, Sr), a = 0 | -(s[16] >>> 7), u = 0; 17 > u; u++)
      s[u] ^= a & (h[u] ^ s[u]);
    for (u = 0; 16 > u; u++)
      l[u] = i[u + 16];
    for (l[16] = 0, v(s, l), u = 0; 16 > u; u++)
      r[n + u] = s[u];
    return 0;
  }
  ...
  function _(r, n, e, t, o) {
    ...
    if (32 > e)
      return -1;
    for (g(r, 0, n, 0, e, t, o), b(r, 16, r, 32, e - 32, r), i = 0; 16 > i; i++)
      r[i] = 0;
    return 0;
  }
  function A(r, n, e, t, o) {
    ...
    if (32 > e)
      return -1;
    if (h(a, 0, 32, t, o), 0 !== p(n, 16, n, 32, e - 32, a))
      return -1;
  ...
  function R(r, n, e) {
    ...
    for (f[0] = w[0] = 1, o = 254; o >= 0; --o)
      t = i[o >>> 3] >>> (7 & o) & 1, d(f, u, t), d(c, w, t), K(y, f, c), T(f, f, c), K(c, u, w), T(u, u, w), L(w, y), L(s, f), Y(f, c, f), Y(c, u, y), K(y, f, c), T(f, f, c), L(u, f), T(c, w, s), Y(f, c, Ar), K(f, f, w), Y(c, c, f), Y(f, w, s), Y(w, u, a), L(u, y), d(f, u, t), d(c, w, t);
    for (o = 0; 16 > o; o++)
      a[o + 16] = f[o], a[o + 32] = c[o], a[o + 48] = u[o], a[o + 64] = w[o];
    var l = a.subarray(32),
        h = a.subarray(16);
    return k(l, l), Y(h, h, l), x(r, h), 0;
  }
  function P(r, n) {
    return R(r, n, br);
  }
  ...
  function J(r, n, e) {
    ...
    for (var s = 0; e >= 128; ) {
      ...
      for (a = 0; 80 > a; a++) {
        for (f = 0; 8 > f; f++)
          c[f] = w[f];
        for (o = M(w[7], X(w[4]), q(w[4], w[5], w[6]), Yr[a], y[a % 16]), c[7] = M(o, V(w[0]), I(w[0], w[1], w[2])), c[3] = M(c[3], o), f = 0; 8 > f; f++)
          w[(f + 1) % 8] = c[f];
        if (a % 16 === 15)
          for (f = 0; 16 > f; f++)
  ...
  r.lowlevel = {
    ...
    yr(r, n, e), cr(e, n);
    for (var t = new Uint8Array(Or + r.length),
        o = new Uint8Array(t.length),
        i = 0; i < r.length; i++)
      t[i + Or] = r[i];
    return t.length < 32 ? !1 : 0 !== A(o, t, t.length, n, e) ? !1 : o.subarray(Pr);
  }, r.secretbox.keyLength = zr, r.secretbox.nonceLength = Rr, r.secretbox.overheadLength = Or, r.scalarMult = function(r, n) {
    if (yr(r, n), r.length !== Nr)
    ...
    if (n && n.getRandomValues) {
      ...
      "undefined" != typeof require && (n = require('@empty'), n && n.randomBytes && r.setPRNG(function(r, e) {
        var t,
            o = n.randomBytes(e);
        for (t = 0; e > t; t++)
          r[t] = o[t];
