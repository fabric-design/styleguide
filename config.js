System.config({
  ...
  map: {
    ...
    "npm:cross-spawn@2.1.5": {
      "cross-spawn-async": "npm:cross-spawn-async@2.1.9",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "spawn-sync": "npm:spawn-sync@1.0.15"
    },
    "npm:cryptiles@2.0.5": {
    ...
    "npm:node-sass@3.4.2": {
      ...
      "chalk": "npm:chalk@1.1.1",
      "cross-spawn": "npm:cross-spawn@2.1.5",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "gaze": "npm:gaze@0.5.2",
